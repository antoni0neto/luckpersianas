...
<head>
    ...
    <!-- Title -->
    <title>Lavagem e Manuten��o de Persianas e Cortinas, ligue: 11 97098-0719 | Luck Persianas</title>
...
\n\n Este e-mail foi enviado automaticamente através do site da Luck Persianas. Não responda.";
			$emailsender='comercial@Luck Persianas.com.br';
			$emaildestinatario='comercial@Luck Persianas.com.br';
			$assunto = "Nova solicitacao de orcamento atraves do seu site, de: ".$email;
			$headers = "MIME-Version: 1.1\n";
			$headers .= "Content-type: text/plain; charset=utf-8\n";
			$headers .= "From: no-reply@Luck Persianas.com.br\r\n"; //E-mail do remetente
			$headers .= "Return-Path: Luck Persianas <comercial@Luck Persianas.com.br>\r\n"; //E-mail do remetente 
			/*$headers .= "Reply-To: comercial@Luck Persianas.com.br\n" */
	...
	if($email !=""){
		...
		$headers .= "From: Nova Solicitação de Orçamento através do seu site <comercial@Luck Persianas.com.br>\n";
